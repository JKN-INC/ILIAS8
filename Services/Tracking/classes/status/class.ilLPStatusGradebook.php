...
class ilLPStatusGradebook extends ilLPStatus
{
	 ...
	 * @return array 
	 */
	public static function _lookupCompletedForObject($a_obj_id, $a_user_ids = null): array
	{
		if (!$a_user_ids) {
	 ...
	 * @return array 
	 */
	public static function _lookupFailedForObject($a_obj_id, $a_user_ids = null): array
	{
		return array();
	}
	 ...
	 * @return array 
	 */
	public static function _lookupInProgressForObject($a_obj_id, $a_user_ids = null): array
	{
		if (!$a_user_ids) {
			$a_user_ids = self::getMembers($a_obj_id);
			if (!$a_user_ids) {
